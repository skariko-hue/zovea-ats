...
- **Kandidaat (Candidate)**: eigen profiel + documenten + trajecten (kliniek pas zichtbaar zodra gekoppeld)
...
## Belangrijkste pagina’s (UI)

- **Login**: `http://localhost:3000/login`
- **Eigenaar**: `/owner` (klinieken: `/owner/clinics`, kandidaten: `/owner/candidates`, trajecten: `/owner/journeys`)
- **Kliniek portal**: `/client`
- **Kandidaat portal**: `/candidate` (profiel bewerken: `/candidate/profiel`)
